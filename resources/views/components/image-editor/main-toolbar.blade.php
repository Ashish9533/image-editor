<div class="flex items-center space-x-2">
    ...
    <button id="browser-btn" title="Browse images from the system gallery" class="flex items-center space-x-2 px-3 py-2 bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 rounded-lg text-sm font-medium transition-colors">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative" id="save-options-container">
        <button id="save-dropdown-btn" title="Save your image to downloads" class="flex items-center space-x-2 px-3 py-2 bg-green-500/20 hover:bg-green-500/30 text-green-300 rounded-lg text-sm font-medium transition-colors disabled:opacity-50" disabled>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div id="save-options-menu" class="hidden absolute right-0 mt-2 w-48 bg-gray-700 rounded-md shadow-lg z-50">
            <a href="#" class="save-option block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600" data-format="png">Download as PNG</a>
            <a href="#" class="save-option block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600" data-format="jpeg" data-quality="0.95">Download as JPEG (High)</a>
            <a href="#" class="save-option block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600" data-format="jpeg" data-quality="0.75">Download as JPEG (Med)</a>
        </div>
    </div>

    <button id="save-to-system-btn" title="Save edited image to the system gallery" class="flex items-center space-x-2 px-3 py-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-300 rounded-lg text-sm font-medium transition-colors disabled:opacity-50" disabled>
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
